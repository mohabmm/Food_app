  ...
  Widget _getListUi(MenuItemViewModel model, BuildContext contextl) {
    return new ListView.builder(
        ...
        itemBuilder: (context, int index) {
          ...
          String describtion = model.menu[index].Description;
          String price = model.menu[index].Price;
          String discount = model.menu[index].Discount;

          return GestureDetector(
            onTap: () {
//              ItemDetailsViewModel itemdetailsviewmodel =
//                  locator<ItemDetailsViewModel>();

              // here i passed the menu item class
